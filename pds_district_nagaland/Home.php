	...
	function setSelectedValue1(obj_value,valueToSet) {
		...
		for (var i = 0; i < obj.options.length; i++) {
			if (obj.options[i].text== valueToSet) {
                ...
                <ul class="breadcrumb">
                    <li><a href="#">Home</a></li>
                    <li class="active">Nagaland Intra Route Optimization For PDS</li>
                </ul>
                <!-- END BREADCRUMB -->
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
								<div class="panel-heading">
                                    <h3 class="panel-title">Nagaland Intra Route Optimization For PDS District - <b><?php echo $district; ?></b> <div id="timer"> <b>Time Left &nbsp </b> <span id="countdown"></span></h3>
                                </div>
                            </div>
							<div class="row">
    ...
    <!-- START SCRIPTS -->
		...
		document.getElementById('downloadCSV').addEventListener('click', async function() {
			try {
				...
				downloadFile(csvBlob, 'Nagaland_Result' + getDateString() + '.csv');
			} catch (error) {
		...
		document.getElementById('downloadXLSX').addEventListener('click', async function() {
			try {
				...
				downloadFile(excelBlob, 'Nagaland_Result' + getDateString() + '.xlsx');
			} catch (error) {
		...
		document.getElementById('downloadPDF').addEventListener('click', async function() {
			try {
				...
				const excelBlob = await excelResponse.blob();
				downloadFile(excelBlob, 'Nagaland_Result' + getDateString() + '.pdf');
			} catch (error) {
